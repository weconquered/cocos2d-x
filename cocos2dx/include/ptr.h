...
public:
	...
	ReferenceType operator*() const { CCAssert(_pointer, "pointer is null"); return *_pointer; }
	PointerType operator->() const { CCAssert(_pointer, "pointer is null"); return _pointer; }
