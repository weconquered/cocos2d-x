...
bool CCModelMd2::load(const char * szFilename)
{
    ...
    const char* fullPath = CCFileUtils::sharedFileUtils()->fullPathFromRelativePath(szFilename);
    ucpBuffer = CCFileUtils::sharedFileUtils()->getFileData(fullPath, "rb", &iFileSize);
